...
try {
	...
	if(map!=null){
		...
		imgSrc=JFreeChartUtils.paintChart(request, session, out, dataSet,rows, width, height, "调解信息统计", Color.RED,usemap);
	}else{
		System.out.println("集合为空！（b0.jsp-line19）");
		imgSrc=JFreeChartUtils.paintChart(request, session, out, null,0, -1, -1, "调解信息统计", Color.RED,usemap);
	}
} catch (Exception e) {
